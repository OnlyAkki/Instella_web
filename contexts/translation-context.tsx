...
const translations: Translations = {
  en: {
    ...
    backToFlags: "Back to {category} Flags",
    flagsAvailable: "flags available in this category",
    screenshot: "Screenshot",
    information: "Information",
    metaConfigSettings: "Meta Config Settings",
    dateAdded: "Date Added",
    dateRemoved: "Date Removed",
    category: "Category",
    tags: "Tags",
    noCategoriesFound: "No Categories Found",
    checkBackLaterFlags: "Check back later for flag categories.",
    loadingFlagsLibrary: "Loading flags library...",
  ...
  es: {
    ...
    flagsLibrary: "Biblioteca de Banderas",
    flagsLibraryDesc:
      "Con esta biblioteca puedes obtener información sobre las banderas de Instagram y entenderlas mejor.",
    searchFlags: "Buscar banderas...",
    categories: "Categorías",
    searchResults: "Resultados de Búsqueda",
    backToCategories: "Volver a Categorías",
    backToFlags: "Volver a Banderas de {category}",
    flagsAvailable: "banderas disponibles en esta categoría",
    screenshot: "Captura de Pantalla",
    information: "Información",
    metaConfigSettings: "Configuración Meta",
    dateAdded: "Fecha Agregada",
    dateRemoved: "Fecha Eliminada",
    category: "Categoría",
    tags: "Etiquetas",
    noCategoriesFound: "No se Encontraron Categorías",
    checkBackLaterFlags: "Vuelve más tarde para categorías de banderas.",
    loadingFlagsLibrary: "Cargando biblioteca de banderas...",
  ...
  fr: {
    ...
    flagsLibrary: "Bibliothèque de Drapeaux",
    flagsLibraryDesc:
      "Avec cette bibliothèque, vous pouvez obtenir des informations sur les drapeaux d'Instagram et mieux les comprendre.",
    searchFlags: "Rechercher des drapeaux...",
    categories: "Catégories",
    searchResults: "Résultats de Recherche",
    backToCategories: "Retour aux Catégories",
    backToFlags: "Retour aux Drapeaux {category}",
    flagsAvailable: "drapeaux disponibles dans cette catégorie",
    screenshot: "Capture d'Écran",
    information: "Information",
    metaConfigSettings: "Paramètres Meta Config",
    dateAdded: "Date Ajoutée",
    dateRemoved: "Date Supprimée",
    category: "Catégorie",
    tags: "Étiquettes",
    noCategoriesFound: "Aucune Catégorie Trouvée",
    checkBackLaterFlags: "Revenez plus tard pour les catégories de drapeaux.",
    loadingFlagsLibrary: "Chargement de la bibliothèque de drapeaux...",
  ...
  de: {
    ...
    flagsLibrary: "Flaggen-Bibliothek",
    flagsLibraryDesc:
      "Mit dieser Bibliothek können Sie Informationen über die Flaggen von Instagram erhalten und sie besser verstehen.",
    searchFlags: "Flaggen suchen...",
    categories: "Kategorien",
    searchResults: "Suchergebnisse",
    backToCategories: "Zurück zu Kategorien",
    backToFlags: "Zurück zu {category} Flaggen",
    flagsAvailable: "Flaggen in dieser Kategorie verfügbar",
    screenshot: "Screenshot",
    information: "Information",
    metaConfigSettings: "Meta-Konfigurationseinstellungen",
    dateAdded: "Hinzugefügt am",
    dateRemoved: "Entfernt am",
    category: "Kategorie",
    tags: "Tags",
    noCategoriesFound: "Keine Kategorien Gefunden",
    checkBackLaterFlags: "Schauen Sie später für Flaggen-Kategorien vorbei.",
    loadingFlagsLibrary: "Lade Flaggen-Bibliothek...",
  ...
  pt: {
    ...
    comingSoon: "Em Breve",
    flagsLibrary: "Biblioteca de Bandeiras",
    flagsLibraryDesc:
      "Com esta biblioteca você pode obter informações sobre as bandeiras do Instagram e entendê-las melhor.",
    searchFlags: "Pesquisar bandeiras...",
    categories: "Categorias",
    searchResults: "Resultados da Pesquisa",
    backToCategories: "Voltar às Categorias",
    backToFlags: "Voltar às Bandeiras {category}",
    flagsAvailable: "bandeiras disponíveis nesta categoria",
    screenshot: "Captura de Tela",
    information: "Informação",
    metaConfigSettings: "Configurações Meta",
    dateAdded: "Data Adicionada",
    dateRemoved: "Data Removida",
    category: "Categoria",
    tags: "Tags",
    noCategoriesFound: "Nenhuma Categoria Encontrada",
    checkBackLaterFlags: "Volte mais tarde para categorias de bandeiras.",
    loadingFlagsLibrary: "Carregando biblioteca de bandeiras...",
  ...
  hi: {
    ...
    flagsLibrary: "फ्लैग्स लाइब्रेरी",
    flagsLibraryDesc: "इस लाइब्रेरी के साथ आप Instagram के फ्लैग्स के बारे में जानकारी प्राप्त कर सकते हैं और उन्हें बेहतर समझ सकते हैं।",
    searchFlags: "फ्लैग्स खोजें...",
    categories: "श्रेणियां",
    searchResults: "खोज परिणाम",
    backToCategories: "श्रेणियों पर वापस जाएं",
    backToFlags: "{category} फ्लैग्स पर वापस जाएं",
    flagsAvailable: "इस श्रेणी में फ्लैग्स उपलब्ध",
    screenshot: "स्क्रीनशॉट",
    information: "जानकारी",
    metaConfigSettings: "मेटा कॉन्फ़िग सेटिंग्स",
    dateAdded: "जोड़ने की तारीख",
    dateRemoved: "हटाने की तारीख",
    category: "श्रेणी",
    tags: "टैग्स",
    noCategoriesFound: "कोई श्रेणी नहीं मिली",
    checkBackLaterFlags: "फ्लैग श्रेणियों के लिए बाद में वापस आएं।",
    loadingFlagsLibrary: "फ्लैग्स लाइब्रेरी लोड हो रही है...",
  ...
  ar: {
    ...
    comingSoon: "قريباً",
    flagsLibrary: "مكتبة الأعلام",
    flagsLibraryDesc: "مع هذه المكتبة يمكنك الحصول على معلومات حول أعلام Instagram وفهمها بشكل أفضل.",
    searchFlags: "البحث عن الأعلام...",
    categories: "الفئات",
    searchResults: "نتائج البحث",
    backToCategories: "العودة إلى الفئات",
    backToFlags: "العودة إلى أعلام {category}",
    flagsAvailable: "أعلام متاحة في هذه الفئة",
    screenshot: "لقطة الشاشة",
    information: "المعلومات",
    metaConfigSettings: "إعدادات التكوين الوصفي",
    dateAdded: "تاريخ الإضافة",
    dateRemoved: "تاريخ الإزالة",
    category: "الفئة",
    tags: "العلامات",
    noCategoriesFound: "لم يتم العثور على فئات",
    checkBackLaterFlags: "عد لاحقاً لفئات الأعلام.",
    loadingFlagsLibrary: "جاري تحميل مكتبة الأعلام...",
